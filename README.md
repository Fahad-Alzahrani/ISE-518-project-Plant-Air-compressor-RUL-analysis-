...
The dataset was collected to support the development of remaining useful life (RUL) prediction models for One Selected Instrument Air Compressors using machine learning methods. It consists of multivariate time series data obtained from several analogue and digital sensors installed on the compressor.

## Project Notebook

| Description | Open |
|------------|------|
| RUL Prediction for Instrument Air Compressor | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Fahad-Alzahrani/ISE-518-project-Plant-Air-compressor-RUL-analysis-/blob/main/ISE_518_Final_Project_Gr11.ipynb) | 
